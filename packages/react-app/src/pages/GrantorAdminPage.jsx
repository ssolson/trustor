...
import { Button, Card, Divider, Input, Form, Space } from "antd";
          ...
          <div className="site-input-group-wrapper">
            <Input.Group compact>
              ...
              <Button
                type={"primary"}
                onClick={async () => {
                  props.tx(props.writeContracts.SimpleT.addGrantor(newGrantorAddr));
                }}
              >
                Add
              </Button>
          ...
          <div className="site-input-group-wrapper">
            <Input.Group compact>
              ...
              <Button
                type={"primary"}
                onClick={async () => {
                  props.tx(props.writeContracts.SimpleT.addTrustee(newTrusteeAddr));
                }}
              >
                Add
              </Button>
