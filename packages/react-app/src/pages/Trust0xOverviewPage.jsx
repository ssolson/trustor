...
import { GrantorTable, TrusteeTable, BeneficiaryTable, SyncChainToDB, Contract, PDFFile } from "../components";
...
export default function Trust0xOverviewPage(props) {
  ...
  const contract = createContractObj("SimpleT", props.localProvider, contractConfig, props.localChainId);
